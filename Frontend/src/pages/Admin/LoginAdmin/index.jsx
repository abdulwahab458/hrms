                ...
                <div className='w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2'>
                    <div className='w-full p-4 sm:p-12.5 xl:p-17.5'>
                        ...
                        <form onSubmit={handleSubmit}>
                            <div className='mb-4'>
                                <label htmlFor='admin-username' className='mb-2.5 block font-medium text-black dark:text-white'>
                                    Username
                                </label>
                            ...
                            <div className='mb-6'>
                                <label htmlFor='admin-password' className='mb-2.5 block font-medium text-black dark:text-white'>
                                    Password
                                </label>
                                <div className='relative'>
                                    <input
